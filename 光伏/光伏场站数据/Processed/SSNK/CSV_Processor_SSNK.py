...
INPUT_CSV = "My_py/光伏/数据/EnRaw/SSNK-2025-En.csv"  # 输入文件路径
OUTPUT_CSV = "My_py/光伏/数据/Processed/SSNK/SSNK-2025-Processed.csv"  # 输出文件路径
COLUMNS_TO_REMOVE = ["time1", "Irradiance", "time2", "Direct radiation"]  # 要删除的列名列表
