...
INPUT_CSV = "/work/zfshu/24learn/hyx-test/My_py/光伏/数据/EnRaw/HHFK-2025-En.csv"  # 输入文件路径
OUTPUT_CSV = "/work/zfshu/24learn/hyx-test/My_py/光伏/数据/Processed/HHFK/HHFK-2025-Processed.csv"  # 输出文件路径
