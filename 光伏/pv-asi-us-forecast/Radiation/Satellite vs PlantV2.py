...
# ====================== 全局配置 ======================
# 数据源1：卫星辐射数据
CSV_PATH_1 = "/work/zfshu/24learn/hyx-test/pv-asi-ultrashort-forecast/Data Process & Analysis/Radiation/himawari_SWR_WXJY_BJT_API_20260130_20260423.csv"
X_COL_1 = "observation_time"
Y_COL_1 = "swr_value"
LABEL_1 = "Himawari"

# 数据源2：场站辐射数据
CSV_PATH_2 = "/work/zfshu/24learn/hyx-test/pv-asi-ultrashort-forecast/Data Process & Analysis/Radiation/武穴站微气象数据_Processed.csv"
X_COL_2 = "ObservationTime"
Y_COL_2 = "Radiation"
LABEL_2 = "Wuxue"

# 时间筛选
START_TIME = "2026-02-01 00:00"
END_TIME = "2026-02-04 23:00"
...
def plot_combined_chart():
    ...
    ax.plot(sorted_1['time'], sorted_1['value'], color='blue', label=f'{LABEL_1} - Shortwave Radiation', linewidth=1.5)
