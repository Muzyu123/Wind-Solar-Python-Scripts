...
# ====================== 全局配置 ======================
# 数据源1
CSV_PATH_1 = "/work/zfshu/24learn/hyx-test/My_py/光伏/数据/Processed/SSNK/SSNK-2024-Processed.csv"
X_COL_1 = "time"
Y_COL_1 = "pv_power"
LABEL_1 = "power" 

# 数据源2
CSV_PATH_2 = "/work/zfshu/24learn/hyx-test/My_py/光伏/数据/Processed/SSNK/SSNK-2024-Processed.csv"
X_COL_2 = "time"
Y_COL_2 = "radiation"
LABEL_2 = "radiation"
...
# 图表样式配置
CHART_TITLE = f"{LABEL_1} vs {LABEL_2} Radiation Data in BJT({START_TIME} ~ {END_TIME})"  
X_LABEL = "Time (HH:MM)"
Y_LABEL = "Normalized Value"
plt.rcParams["axes.unicode_minus"] = False

# 保存路径
SAVE_PATH = "/work/zfshu/24learn/hyx-test/Wind-Solar-Python-Scripts/光伏/光伏场站数据/Processed/WXJY/2024.png" 
...
def plot_combined_chart():
    ...
    ax.plot(sorted_1['time'], normalize(sorted_1['value']), color='blue', label=f'{LABEL_1} - Shortwave Radiation', linewidth=1.5)
    ...
    ax.plot(sorted_2['time'], normalize(sorted_2['value']), color='darkorange', label=f'{LABEL_2} - {Y_COL_2}', linewidth=1.5)
    ...
    y_min = normalize(all_values).min()
    y_max = normalize(all_values).max()
    y_range = y_max - y_min
